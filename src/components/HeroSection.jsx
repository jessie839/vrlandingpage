  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            VirtualR offers fast and reliable build tools designed to simplify development workflows. It automates compiling, packaging, and deployment, helping developers work smarter and deliver faster.
        </p>
